...
from CUSTOMER2
left join  ORDERS
on CUSTOMER2.customer_id= ORDERS.customer_id
left join SALESMAN
...
select SALESMAN.name, COUNT(customer2.salesman_id) as total_customer
from SALESMAN right outer join CUSTOMER2
on SALESMAN.salesman_id= CUSTOMER2.salesman_id
group by cus
...
select * from SALESMAN cross join CUSTOMER2
