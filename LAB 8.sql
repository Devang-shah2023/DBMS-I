...
SELECT YEAR, PRODUCT, SUM(SALES_AMOUNT) AS TOTAL_SUM
FROM SALES_DATA
GROUP BY YEAR, PRODUCT
--7. Display Regions with Total Sales Greater Than 5000
SELECT REGION, SUM(SALES_AMOUNT) AS TOTAL_SUM
FROM SALES_DATA
GROUP BY REGION
...
SELECT SUM(SALES_AMOUNT) AS TOTAL_SALES, REGION FROM SALES_DATA
WHERE YEAR=2023
GROUP BY REGION
...
SELECT YEAR, REGION, COUNT(PRODUCT) AS PRODUCT_COUNT
FROM SALES_DATA
GROUP BY YEAR, REGION
ORDER BY YEAR, REGION
--2. Display Regions with Maximum Sales Amount Exceeding 1000 in Any Year, Sorted by Region
SELECT REGION, YEAR, MAX(SALES_AMOUNT) AS MAXIMUM_SALES
FROM SALES_DATA
GROUP BY YEAR, REGION
